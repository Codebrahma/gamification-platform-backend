...
* Need a good README for the project. Contents of this README is from [Hapi Starter Kit](https://github.com/Codigami/hapi-starter-kit)

## Overview

Need a good project overview. Pull Requests for this are welcome.
